...
- The selected `plans/release-0.7.0.pert` workstream sequences six serial tasks
  ...
  601-file tarball agree at SHA-256 `8585adb5...f4d623`; `latest=0.6.0` and
  absent `alpha` remain unchanged. `RELEASE_070_PUBLISH` is complete, and fresh
  complete NextResult v6 recommends only `RELEASE_070_ACCEPTANCE`. Durable
