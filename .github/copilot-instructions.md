...
- The CLI/help review is tracked independently in `plans/cli-surface-reset.pert`. The plan does not accept or implement Contract 3; `CONTRACT_V3_DESIGN` is its only initial recommendation.
