...
The explicitly selected `TIME-001` and `UNIT-001` workstream is tracked by the milestone-level `plans/scheduling-units.pert` and its milestone details. SU-M1 and SU-M2 are complete and advanced at `24p/1d` each. After reviewing the accepted finite-decimal migration limit, the user selected an exact rational Duration extension as new common milestone SU-M2R before SU-M3 and SU-M4. All seven SU-M2R tasks are complete and advanced at provisional `24p/1d`; the acceptance implementation is committed at `29550c5`. The [SU-M2R acceptance record](docs/process/scheduling-units-m2r-acceptance.md) traces TUI/TUE through 020, fixes exact TUE-015 representation without claiming the later migration command, and verifies internal composition, closed root exports, the unchanged 27-command registry, and installed Contract 3 rejection of Grammar 2/3. The advanced detail has zero precedence and heuristic resource makespans and no recommendation, with digest `sha256:5ba8eb9d5ec192f2d30568e1c51ebba670c4c496b232e6ad8bb9e965490931bb`. Until the committed detail is rolled up once, the macro remains at `0.166667d`, with `4.166667d` precedence and `6.166667d` heuristic resource makespans, 2d delay, and a recommendation for `SU_M2R_RATIONAL_DURATION_WORK_PACKAGE`. Active Grammar 1, accepted target Grammar 2, CLI Contract 3, public result schemas, root exports, help, Guide, Next v3 authority, and publication remain unchanged. SU-M3 owns temporal analysis, SU-M4 owns unit-migration orchestration and UnitMigrationResult v2, and SU-M5 owns public Contract 4 activation.
