...
- `src/application/`: pure services for check/project initialization/project metadata/analyze/next and active/target mutation planning that return validated documents or revalidated candidates.
