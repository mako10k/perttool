...
The explicitly selected `TIME-001` and `UNIT-001` workstream is tracked by the milestone-level `plans/scheduling-units.pert` and its milestone details. SU-M1 and SU-M2 are complete and advanced at `24p/1d` each. After reviewing the accepted finite-decimal migration limit, the user selected an exact rational Duration extension as new common milestone SU-M2R before SU-M3 and SU-M4. `RATIONAL_DURATION_CONTRACT`, `RATIONAL_DURATION_SOURCE_MODEL`, `EXACT_DURATION_SERIALIZER`, `RATIONAL_DURATION_FORMATTER`, `RATIONAL_DURATION_MUTATION`, and `RATIONAL_DURATION_VERSION_BOUNDARY` are committed and advanced. The internal boundary, committed at `fa698ca`, selects Grammar 1/2 retention or Grammar 3 upgrade from canonical generated tokens, returns grammar/qualification/reversibility metadata, and produces only a localized version edit for later atomic composition. Four points remain; precedence and heuristic resource makespans are both 4p with no delay, and both inherited forecasts are `1/6d`. The detail digest is `sha256:63bbe45287126762e0e27ca09b0a4822968a6ab1a5aee9f5dfb7410ffc5590e6`. The macro rollup is `0.166667d`, leaving `4.166667d` precedence and `6.166667d` heuristic resource makespans with 2d delay. Complete Next v3 recommends `SU_M2R_RATIONAL_DURATION_WORK_PACKAGE` in the macro and `RATIONAL_DURATION_ACCEPTANCE` in the detail. Active Grammar 1, accepted target Grammar 2, CLI Contract 3, public result schemas, root exports, the 27-command registry, help, Guide, and installed behavior remain unchanged. Public Contract 4 activation, unit-migration command publication, Next v4 authority, release, and external distribution remain later gates.
