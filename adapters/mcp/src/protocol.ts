...
export const MCP_SERVER_VERSION = "0.10.2" as const;
...
export const MCP_RESOURCE_DEFINITIONS = Object.freeze([
  ...
  Object.freeze({
    ...
    description: "Complete Contract 9 command discovery.",
  }),
  Object.freeze({
    uri: "perttool://guide/index",
    name: "perttool guide index",
    description: "Contract 9 Guide topic index.",
  }),
  Object.freeze({
...
export const MCP_TOOL_DEFINITIONS = Object.freeze([
  Object.freeze({
    ...
    resultSchemaVersion: "Perttool.CheckResult.v6",
  ...
  Object.freeze({
    ...
    resultSchemaVersion: "Perttool.AnalysisResult.v7",
  ...
  Object.freeze({
    ...
    description: "Read deterministic Contract 9 command help or Guide content.",
