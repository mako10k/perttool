...
| `cli-surface-reset.pert` | `CONTRACT_V3_DESIGN`, `CLI_001_COMMAND_REGISTRY`, `HELP_001_COMMAND_DISCOVERY`, `HELP_003_USAGE_RECOVERY`, `MUT_001_PROJECT_INIT`, `MUT_002_GATE_MAINTENANCE` | 36p | 1d | `36p/1d` | precedence/resource `13/36d` |
...
3. Check the advance preview.
4. Check the list of tasks and milestones to be removed.
5. Check the ready set after the write.
6. Commit to Git.
