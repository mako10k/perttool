...
| `cli-surface-reset.pert` | `CONTRACT_V3_DESIGN`, `CLI_001_COMMAND_REGISTRY`, `HELP_001_COMMAND_DISCOVERY`, `MUT_001_PROJECT_INIT`, `MUT_002_GATE_MAINTENANCE` | 31p | 1d | `31p/1d` | precedence `15/31d`; resource `18/31d` |
