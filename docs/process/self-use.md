...
- Document status: Active Stage 3 / Revision 2.42
...
source task through a cumulative `9p/1d` sample and will be advanced only from
the resulting clean committed snapshot. Four tasks and 15p remain; precedence
