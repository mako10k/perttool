...
test("0.10.1 selects the compatible Issue 22 patch and retains public identities", async () => {
  ...
  assert.equal(lsp.peerDependencies.perttool, "0.10.6");
  assert.equal(mcp.peerDependencies.perttool, "0.10.6");
  ...
  assert.match(readme, /Version `0\.10\.5` remains\s+the exact rollback pin/u);
