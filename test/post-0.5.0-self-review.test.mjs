...
test("current guidance records the published 0.5.2 schema boundary", async () => {
  ...
  assert.match(
    agents,
    /`planning-pool\.pert`, `planning-pool-release-readiness\.pert`, and `release-0\.2\.0\.pert` through `release-0\.10\.0\.pert` as independent post-beta workstreams/,
  );
  assert.doesNotMatch(
    agents,
  ...
  assert.match(schemaContract, /The twenty-five command identities are command results/);
