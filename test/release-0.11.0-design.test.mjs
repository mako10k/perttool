...
test("0.11.0 gate candidate selects Planning Pool and retains separate publication authority", async () => {
  ...
  assert.match(procedure, /- Status: Gate design candidate 1\.4; owner acceptance pending/u);
  ...
  assert.match(gate, /- Document status: Candidate 1\.4; owner acceptance pending/u);
  ...
  assert.match(correction, /Status: Candidate 1\.4 corrective implementation and complete local gate\n  passed; independent re-review and PERT assurance outcome pending/u);
