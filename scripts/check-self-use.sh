...
plans=(plans/control-plane.pert plans/grammar.pert plans/operations.pert plans/mvp.pert)
...
printf 'read-only self-use checks passed (4 plans; check, analyze, next)\n'
